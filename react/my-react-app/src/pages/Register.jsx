                ...
                <div className="auth-box">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" className="form-input" placeholder="Tech Solutions JSC" required />
                        </div>

                        <div className="form-group">
                            <label className="form-label">Mật khẩu</label>
                            <input type="password" className="form-input" placeholder="Tối thiểu 8 ký tự" required />
                        </div>
