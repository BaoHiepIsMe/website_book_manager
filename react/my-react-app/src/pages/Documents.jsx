                ...
                <div className="folder-section">
                    ...
                    <div className="folder-grid">
                        <div className="folder-card">
                            ...
                            <div>
                                <div style={{fontWeight: 600, fontSize: '14px'}}>Hợp đồng</div>
                        ...
                        <div className="folder-card">
                            <i className="fas fa-folder folder-icon"></i>
                            <div>
                                <div style={{fontWeight: 600, fontSize: '14px'}}>Hóa đơn & Tax</div>
                        ...
                        <div className="folder-card">
                            <i className="fas fa-folder folder-icon"></i>
                            <div>
                                <div style={{fontWeight: 600, fontSize: '14px'}}>Nhân sự (HR)</div>
                        ...
                        <div className="folder-card">
                            <i className="fas fa-folder folder-icon"></i>
                            <div>
                                <div style={{fontWeight: 600, fontSize: '14px'}}>Marketing</div>
